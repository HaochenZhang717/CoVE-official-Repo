...
dataset_name="llama3.23B-lora-only-noqloraall-ours-beauty-${compression_rate}-lora${adapter_dim}-batch${effective_batch_size}-num_hashes${num_hashes}-lr${lr}"
dst_path="./llama3.23B-lora-only-noqloraall-ours-beauty-${compression_rate}-lora${adapter_dim}-batch${effective_batch_size}-num_hashes${num_hashes}-lr${lr}"
