...
def main():
    ...
    # if int(model_args.compression_rate) > 1:
    #     for param in model.base_model.model.model.embed_tokens.item_embed.embedding.parameters():
    #         param.requires_grad = True
    #     for param in model.base_model.model.lm_head.item_lm_head.proj.parameters():
    #         param.requires_grad = True
    # else:
    #     for param in model.base_model.model.model.embed_tokens.item_embed.parameters():
    #         param.requires_grad = True
    #     for param in model.base_model.model.lm_head.item_lm_head.parameters():
    #         param.requires_grad = True
